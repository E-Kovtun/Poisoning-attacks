        ...
        for model_name in model_names:
                for loss_name in loss_names:
                    for i in num_launches:    
                        ...
                        checkpoint_dma_folder = os.path.join(checkpoints_folder, data_name, model_name, attack_name, loss_name)
                        ...
                        for epoch in range(1, 500):
                            ...
                            for batch_tuple, batch_tuple_clean in tqdm(zip(poisoned_train_dataloader, train_dataloader), total=len(poisoned_train_dataloader)):
                                ...
                                loss = loss_func(output, batch_target) + 10 * loss_pearson(output_on_clean.softmax(dim=1), output_clean.softmax(dim=1))
                        ...
                        result_dma_folder = os.path.join(results_folder, data_name, model_name, attack_name, loss_name)
